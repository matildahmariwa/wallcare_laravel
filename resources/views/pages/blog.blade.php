...
<div class="grid-x " style="padding:60px;">
        @foreach($blogs as $blog)
      
    <div class="cell large-4 medium-4 small-12 blog" style="padding:36px;margin-top: 33px;  box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); ">

        <a href="{{route('blogs',$blog->id)}}" style="text-decoration:none; ">

    <p class="blog-head">{{$blog->blog_title}}</p>

    <div class="blog-body">{!! \Illuminate\Support\Str::words($blog->blog_body, 50,'...')  !!}</div>
